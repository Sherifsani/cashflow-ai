...
export const BrandingPanel: React.FC<{ currentStep: number }> = ({ currentStep }) => {
  return (
    <div className="hidden lg:flex bg-[#2D3540] p-12 flex-col justify-between text-white relative overflow-y-scro">
      ...
      <div className="relative z-10">
        <div className="flex items-center mb-12">
          ...
          <div>
            ...
            <p className="text-[#00A878]/80">Join 500+ Nigerian SMEs</p>
          </div>
        </div>
