        ...
        <div>
            <div className="relative">
                ...
                <input
                    ...
                    className={`peer block w-full ${inputPadding} pr-10 pb-1 pt-4 border border-app-border rounded-lg bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary ${error ? 'border-red-300 bg-red-50' : 'border-app-border'}`}
                />
